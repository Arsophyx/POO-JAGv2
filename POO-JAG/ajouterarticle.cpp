...
namespace POO_JAG {
    ...
    void ajouterarticle::InitializeComponent(void)
    {
        ...
        this->label6->Click += gcnew System::EventHandler(this, &ajouterarticle::label6_Click);
        // 
        // textBox6
        // 
        ...
        this->textBox6->TextChanged += gcnew System::EventHandler(this, &ajouterarticle::textBox6_TextChanged);
        // 
        // ajouterarticle
        // 
