...
namespace POO_JAG {
    ...
    private: System::Void button1_Click_1(System::Object^ sender, System::EventArgs^ e) {
        ...
        if (!double::TryParse(textBox1->Text, textBox1Value)) {
            MessageBox::Show("Veuillez remplir Solde Reglement de la Commande en tant que decimal/entier.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
        ...
        if (!VerifierExistenceidclient(textBox6->Text)) {
            MessageBox::Show("L'id du Client indiquee n'existe pas.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
    ...
    private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        if (textBox3->Text->Length > 10) {
            MessageBox::Show("La date emission de la Commande ne peut pas faire plus que 10 caractères et doit etre ecrit sur ce format : JJ/MM/AAAA.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
        if (textBox4->Text->Length > 10) {
            MessageBox::Show("La date Payement de la Commande ne peut pas faire plus que 10 caracteres et doit etre ecrit sur ce format : JJ/MM/AAAA.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
        ...
        if (!VerifierExistenceidarticle(textBox7->Text)) {
            MessageBox::Show("L'id article indiquee n'existe pas.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
        if (!VerifierExistenceidclient(textBox6->Text)) {
            MessageBox::Show("L'id du Client indiquee n'existe pas.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
        ...
        if (!VerifierExistencearticledouble(textBox7->Text)) {
            MessageBox::Show("L'id article indiquee a deja ete ajoute à la commande.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
        if (this->oSvcCommande->verifierStock(textBox7->Text, textBox8->Text) == 0) {
            MessageBox::Show("Il n'y a pas assez d'articles en stock pour le nombre d'articles rentre.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
        }
        else {
            if (this->oSvcCommande->verifierIntegrer(textBox7->Text, textBox1->Text, textBox2->Text, textBox3->Text, textBox4->Text, textBox5->Text, textBox6->Text) == 1) {
                ...
                MessageBox::Show("Cet article existe deja dans la commande", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            }
        }
    }
