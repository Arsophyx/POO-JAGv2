...
namespace POO_JAG {
    ...
    void modifierclient::InitializeComponent(void)
    {
        ...
        this->label6->Click += gcnew System::EventHandler(this, &modifierclient::label6_Click);
        // 
        // textBox6
        // 
        ...
        this->textBox6->TextChanged += gcnew System::EventHandler(this, &modifierclient::textBox6_TextChanged);
        // 
        // modifierclient
        // 
