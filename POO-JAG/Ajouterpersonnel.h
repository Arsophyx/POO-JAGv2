...
namespace POO_JAG {
    ...
    private: System::Void button1_Click_1(System::Object^ sender, System::EventArgs^ e) {
        ...
        if (!int::TryParse(textBox6->Text, textBox6Value)) {
            MessageBox::Show("Veuillez remplir ID du superieur en tant qu'entier.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
        int textBox5Value;
        ...
        if (textBox3->Text->Length < 10) {
            MessageBox::Show("Le date de la prise de poste du personnel doit etre ecrit sur 10 caractères et doit etre ecrit sur ce format : JJ/MM/AAAA.", "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
            return;
        }
